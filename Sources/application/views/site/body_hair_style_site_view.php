...
<div class="container">
	<div class="row" style=" border-bottom: 2px solid orangered;">
		<div class="col-md-5 text-left" style="padding-top: 20px">
			<img alt="ha1" src="<?php echo base_url(); ?>assets/img/tocdep2.jpg" style="width:300px; height:auto;"class="mb-3" />
		</div>
        ...
        Tóc nam MOHICAN
			...
			<p>
       Nếu bạn là một người ưa thích sự phá cách trong thời trang và liên tục muốn làm mới phong cách của mình, thì Mohican chính là kiểu đầu hoàn hảo dành cho bạn. Trên thế giới không thiếu gì những ngôi sao nam tỏ ra “mê mẩn” Mohican như David Beckham, Justin Bieber, ZaynMalik…Nhưng riêng với ZaynMalick, kiểu đầu này dường như đã trở thành một thương hiệu đặc trưng khiến bao trái tim fan nữ phải thổn thức bởi nét trẻ trung, phá cách đầy cá tính nhưng vẫn mang vẻ lịch lãm đầy cuốn hút...
      </p>
        <a href="<?php echo base_url();?>/index.php/hairmohican/index">
	...
	<div class="row" style=" border-bottom: 2px solid orangered;">
		<div class="col-md-5 text-left" style="padding-top: 20px">
			<img alt="ha1" src="<?php echo base_url(); ?>assets/img/tocdep3.jpg" style="width:300px; height:auto;" class="mb-3" />
		</div>
		<div class="col-md-7 text-justify">
			<h3 class="mt-3">
        Tóc nam SIDE PART
       ...
       Điều khác biệt ở thời kì bấy giờ đó là, không phải ai cũng để được kiểu tóc này. Nó đại diện cho tầng lớp thượng lưu, những doanh nhân giàu có hay những vị tướng đang phục vụ cho quân đội quốc gia, kiểu tóc là đại diện cho quyền lực, sự mạnh mẽ nam tính cũng như sự lịch lãm và tất cả những điều mà một người đàn ông thực thụ cần có...
			...
			<a href="<?php echo base_url();?>/index.php/hairsidepart/index">
			<button class="btn btn-dark mb-3" style="float:right;">
        Xem thêm
      </button>
			</a>
		...
		<div class="row" style=" border-bottom: 2px solid orangered;">
		<div class="col-md-5 text-left" style="padding-top: 20px">
			<img alt="ha1" src="<?php echo base_url(); ?>assets/img/tocdep4.jpg" style="width:300px; height:auto;" class="mb-3" />
		</div>
		<div class="col-md-7 text-justify">
			<h3 class="mt-3">
        Tóc nam SPORT (Short Quiff)
			</h3>
			<p>
      ...
      Quiff nhanh chóng trở thành một kiểu các kiểu tóc nam đẹp ưa thích khi bạn có thể bất chấp tuổi tác...
			...
			<a href="<?php echo base_url();?>/index.php/hairsport/index">
				<button class="btn btn-dark mb-3" style="float:right;">
				 Xem thêm
      </button>
			</a>
		...
		<div class="row">
		<div class="col-md-5 text-left" style="padding-top: 20px">
			<img alt="ha1" src="<?php echo base_url(); ?>assets/img/tocdep5.jpg" style="width:300px; height:auto;" />
		</div>
		<div class="col-md-7 text-justify">
			<h3 class="mt-3">
        Tóc Nam UNDERCUT
    ...
    Undercut là kiểu tóc tỉa gọn hay cạo ở hai bên và phía sau giữ lại phần tóc mái phía trước và phần trên của đầu vẫn để dài giống như ý nghĩ của nó khi dịch ra có nghĩ là cắt phần ở dưới..
				...
				<a href="<?php echo base_url();?>/index.php/hairundercut/index">
					<button class="btn btn-dark mb-3" style="float:right;">
       			 Xem thêm
     			 </button>
				</a>
