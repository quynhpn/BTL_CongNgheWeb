...
--
-- Máy chủ: 127.0.0.1
-- Thời gian đã tạo: Th1 03, 2019 lúc 03:33 PM
...
INSERT INTO `chitietdv` (`MaDV`, `Buoc`, `Chitietbuoc`, `MACTDV`) VALUES
('D1', '', 'Thay đổi phong cách của bạn với mái tóc xoăn bồng bềnh.', 1),
('D2', '', 'Hỗ trợ cho những bạn muốn nhuộm mái tóc sáng màu.', 2),
('D3', '', 'Thay đổi diện mạo với hàng trăm màu tóc thời trang với mức giá khó tin chỉ 200000. Sử dụng màu nhuộm cao cấp, tư vấn giữ màu tốt nhất.', 3),
('CB2', 'Bước 1: Massage chân muối Himalaya -', 'Cải thiện sức khỏe', 4),
('CB2', 'Bước 2: Rửa mặt -', 'Tút lại vẻ đẹp trai của bạn', 5),
('CB2', 'Bước 3: Đắp Mặt Nạ Dưỡng Da, Sạch Mụn - ', 'Mặt nạ tinh chất than hoạt tính giúp sạch sâu từng lỗ chân lông', 6),
('CB2', 'Bước 4: Gội đầu bấm huyệt - ', 'Một cảm giác sảng khoái nhất mà bạn từng biết đến', 7),
('CB2', 'Bước 5: Massage Thư Giãn Da Mặt, Vai Gáy - ', 'Cảm nhận sự thư thái từ đôi bàn tay mướt mịn của các Spa Girl', 8),
('CB2', 'Bước 6: Chăm sóc da mặt bằng công nghệ cao - ', 'Hút sạch bã nhờn, mụn đầu đen, xịt khoáng chất', 9),
('CB2', 'Bước 7: Massage Vitamin E & Đá cẩm thạch -', ' Trắng da, mờ nếp nhăn', 10),
('CB2', 'Bước 8: Tư Vấn Tạo Kiểu - ', 'Tư vấn tạo kiểu tận tình theo từng khuôn mặt', 11),
('CB2', 'Bước 9: Cắt Tóc Tạo Kiểu - ', 'Bằng những đôi bàn tay khéo léo của những thợ giỏi nhất nước', 12),
('CB2', 'Bước 10: Cạo Mặt Êm Ái - ', 'Cạo mặt êm ái giúp làn da khỏe khoắn, sáng ngời', 13),
('CB2', 'Bước 11: Xả Tóc - ', 'Xả sạch tóc con, không lo ngứa ngáy', 14),
('CB2', 'Bước 12: Sấy Tạo Kiểu, Vuốt Sáp, Xịt Gôm -', 'Đẹp trai lột xác ngay lập tức', 15),
('CB1', 'Bước 1: Gội xả sạch -', 'Gội sạch tóc', 24),
('CB1', 'Bước 2: Tư Vấn Tạo Kiểu -', 'Tư vấn tạo kiểu tận tình theo từng khuôn mặt', 25),
('CB1', 'Bước 3: Cắt Tóc Tạo Kiểu -', 'Bằng những đôi bàn tay khéo léo của những thợ giỏi nhất nước', 26),
('CB1', 'Bước 4: Cạo Mặt Êm Ái -', 'Cạo mặt êm ái giúp làn da khỏe khoắn, sáng mịn', 27),
('CB1', 'Bước 5: Xả Tóc -', 'Xả sạch tóc con, không lo ngứa ngáy', 28),
('CB1', 'Bước 6: Dưỡng tóc Tinh dầu - ', 'Giúp mái tóc mềm mại, chắc khỏe', 29),
('CB1', 'Bước 7:Sấy Tạo Kiểu, Vuốt Sáp, Xịt Gôm -', 'Đẹp trai lột xác ngay lập tức', 30);
...
CREATE TABLE `khachhang` (
  `SDTKH` char(20) COLLATE utf8mb4_unicode_ci NOT NULL,
  `TenKH` tinytext COLLATE utf8mb4_unicode_ci,
...
('0123425436', 'Phạm Thị Thùy', 'Định Công'),
('0325387474', 'Vũ Minh Huy', 'Định Công'),
('0965248932', 'Hà Việt Tùng', 'Gia Lâm'),
('0965637450', 'Nguyễn Xuân Trường', 'Thanh Xuân-Hà Nội'),
('096875432', 'Phạm Ngọc Quỳnh', 'Nghệ An'),
('0974628362', 'Phạm Minh Thùy', 'Nghệ An'),
('0976812233', 'Phạm Minh Thùy', NULL),
('09768123122', 'Phạm Minh Thùy', NULL),
('0976836281', 'Đào Thị Thùy', 'Hà Nội'),
('0976836281123', '', ''),
('09768362815', '', ''),
('097683628153', '', ''),
('0976836281536', '', ''),
('097683628154', '', ''),
('0984829942', 'Phạm Minh Thùy', NULL),
...
('123123', '', ''),
('123456476', '', ''),
('123456789', 'Đào Thị Thùy', '2315'),
('123546789', '', ''),
('1324256', 'Phạm Minh Thùy', NULL),
('2142354', 'Thơm', NULL),
('234567', 'Thơm', NULL),
('23456708978', 'Thơm', NULL),
('2345674', '', ''),
('23456749789', 'Phạm Minh Thùy', NULL),
('23456879', 'Phạm Minh Thùy', NULL),
('965637450', 'Lê Phương Thảo', 'Cầu Giấy'),
('974628362', 'Phạm Minh Thùy', NULL),
('9856314234', 'Phạm Ngọc Quỳnh', 'Định Công'),
('abc', '\r\n        qưdz                            ', ''),
('abcádfgh', '\r\n        qưdz                            ', '\r\n               xáqwdef                     '),
('Tóc nam SIDE PART', 'Mẫu tóc nam Side part đã có lịch sử từ rất lâu khoảng thời thế chiến thứ 2, vào thời kì đó rất nhiều người đàn ông đã để kiểu tóc này và nó đã trở thành một kiểu tóc rất phổ biến vào lú', 'Tóc nam SIDE PART\r\nMẫu tóc nam Side part đã có lịch sử từ rất lâu khoảng thời thế chiến thứ 2, vào thời kì đó rất nhiều người đàn ông đã để kiểu tóc này và nó đã trở thành một kiểu tóc rất phổ biến vào lúc đó như sự thống trị của Undercut ngày nay.\r\nĐiều khác biệt ở thời kì bấy giờ đó là, không phải ai cũng để được kiểu tóc này. Nó đại diện cho tầng lớp thượng lưu, những doanh nhân giàu có hay những vị tướng đang phục vụ cho quân đội quốc gia, kiểu tóc là đại diện cho quyền lực, sự mạnh mẽ nam tính cũng như sự lịch lãm và tất cả những điều mà một người đàn ông thực thụ cần có. Nhưng đến thời điểm này, thời kì của sự tự do không phân giai cấp thì ai ai cũng có thể lựa chọn và để kiểu tóc này miễn sao nó phù hợp với khuôn mặt dáng người cũng như phù hợp với công việc cũng như độ tuổi. Trước khi ngắm nghía những kiểu side part đẹp thì hãy cùng ad tìm hiểu xem thế nào là Side Part nhé.Mẫu tóc Side part có mấy loại?\r\nSide part có 2 dòng khác nhau bên cạnh đó còn một vài biến thể khác của kiểu tóc này nữa, đó là:\r\nSide part cổ điển:\r\nLà kiểu tóc có phần tóc xung quanh được tỉa gọn gàng nhưng không cạo trắng nhưng để hơi dài một chút khoảng 1,5cm và vuốt theo chiều ra phía sau, phần tóc phía trên được chia theo tỉ lệ 2/8 hoặc 3/7 và tạo kiểu với những lọn tóc hơi xoăn một chút ở phần mái hoặc sóng nhẹ cả đầu mang đến cho bạn một cảm giác rất “ vintage” phù hợp với những bạn ưa thích phong cách lịch lãm kiểu của các quý ông trong bộ tuxedo hoặc măng tô.\r\nSide part hiện đại:\r\nLà kiểu tóc đã được thiết kế lại bởi những barber chuyên nghiệp với những cải tiến độc đáo và mang hơi hướng hiện đại và trẻ trung hơn rất nhiều. Với phần ngôi không chia vào quá sâu như side part cổ điển nữa mà được cắt cao hơn một chút mang lại sự khỏe khoắn nhưng vẫn không kém phần thanh lịch và lịch lãm, vẫn phù hợp với những bạn đang đi học hay đã đi làm tại các cơ quan hành chính. Vì sự “đa năng” của nó mang lại giúp bạn có thể ứng dụng kiểu tóc này vào những tình huống khác nhau và các trang phục khác nhau mà không làm mất đi vẻ “đep trai phong trần” của mình.\r\nSide part 4/6 ( Phong cách tóc nam Hàn Quốc cho năm 2017 )\r\nKiểu tóc này thường có độ dài trung bình khoảng 9cm có thể chạm mắt hoặc dài qua mắt một chút, với những bạn có tóc thẳng thì các bạn cần uốn xoăn nhẹ để phá đi chất tóc thẳng của mình để đi vuốt bằng những loại wax có độ ẩm hoặc gel hì kiểu tóc sẽ trông tự nhiên và hài hòa hơn. Kiểu tóc này có phần chia khá sâu phù hợp với những bạn có khuôn mặt dài và trái xoan hoặc mặt vuông.\r\n\r\n                                    ');
...
CREATE TABLE `lichhen` (
  ...
  `MaNV` varchar(30) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'CK',
  `SDTKH` char(20) COLLATE utf8mb4_unicode_ci NOT NULL,
...
('09:00:00', '2019-01-12', 'NV01', '0965637450', 0),
('16:00:00', '2019-01-04', 'CK', '0976836281', 0),
('15:30:00', '2019-01-04', 'CK', '11111111111111111111', 0),
('09:00:00', '2019-01-03', 'CK', '123456476', 0),
('17:05:00', '2512-12-18', 'CK', '234567', 0),
('00:09:00', '2018-11-12', 'AD', '2345674', 0);
...
('AD', 'Bùi Huy Hùng', '0984898418', 'huymanh@gmail.com', 'Quản trị', 1),
('CK', 'Lê Đình Tuân', '0972718434', 'dinhtuan@gmail.com', 'Lễ tân', 1),
('NV01', 'Nguyễn Hồng', '976457892', 'jnuyb@gmail.com', 'Nhân viên', 1),
('NV02', 'Pham Van Hoang', '091382731', 'pnh@gmail.com', 'Nhân viên', 1),
('NV03', 'Phan Mạnh Nam', '0962892018', 'manhn365am@gmail.com', 'Nhân viên', 1),
('NV04', 'Đào Duy Tùng', '0974802358', 'duytung@gmail.com', 'Nhân viên', 1),
('NV05', 'Đỗ Văn Đức', '0968892378', 'vanduc@gmail.com', 'Nhân viên', 1),
('NV06', 'Phạm Ngọc Quỳnh', '0965637450', 'pnquynh2403@gmail.com', 'Nhân viên', 1),
('NV09', 'Đào Thi Thơm', '0129846213', 'dtthom@gmail.com', 'Nhân viên', 1),
('NV10', 'Đào Thi Thơm', '0129846213', 'dtthom@gmail.com', 'Nhân viên', 1),
('NV11', 'NV11', '1323546', 'jnuyb@gmail.com', 'Nhân viên', 0),
('NV12', 'Lê Thu Phương', '1323546', 'jnuyb@gmail.com', 'Nhân viên', 0),
('NV13', 'Lê Thu Phương', '1323546', 'jnuyb@gmail.com', 'Lễ tân', 0),
('NV15', 'Lê Thu Phương', '1323546', 'jnuyb@gmail.com', 'Nhân viên', 1),
('NV16', 'Phạm Ngọc Quỳnh', '0965637450', 'jnuyb@gmail.com', 'Nhân viên', 0),
('NV17', 'Vũ Minh Huy', '0965637450', 'vmhuy@gmail.com', 'Nhân viên', 0),
('NV18', 'Vũ Minh Hiếu', '0965645678', 'vmhieu@gmail.com', 'Nhân viên', 0);
...
('nhanvien1', '444444', 'NV01', 1),
('nhanvien2', '1234556', 'NV02', 1),
...
('checkin', '123456', 'CK', 1),
('DTT', '123456', 'NV09', 1),
('DaothiThom', '123456', 'NV10', 1),
('PHN', '123456', 'NV11', 1),
('edaedde', '123456', 'NV12', 1),
('edfxghdjxdx', '123456', 'NV13', 1),
('TK2', '123456', 'NV15', 1),
('tk3', '123456', 'NV16', 1),
('TK17', '', 'NV17', 1),
('TK18', '12e3454', 'NV18', 0);
...
--
ALTER TABLE `lichhen`
  ADD PRIMARY KEY (`SDTKH`,`GioHen`,`NgayHen`),
  ADD KEY `MaNV` (`MaNV`);
...
--
ALTER TABLE `baiviet`
  MODIFY `MaBV` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;

--
-- AUTO_INCREMENT cho bảng `chitietdv`
--
ALTER TABLE `chitietdv`
  MODIFY `MACTDV` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=31;
